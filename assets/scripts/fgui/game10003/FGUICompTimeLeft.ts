...
export default class FGUICompTimeLeft extends fgui.GComponent {
	...
	public static URL:string = "ui://2zsfe53xc82627";
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10003", "CompTimeLeft") as FGUICompTimeLeft;
	...
	public static createInstance():FGUICompTimeLeft {
		return <FGUICompTimeLeft>(fgui.UIPackage.createObject("game10003", "CompTimeLeft"));
	}
