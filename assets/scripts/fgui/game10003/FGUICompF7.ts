...
export default class FGUICompF7 extends fgui.GComponent {
	...
	public static URL:string = "ui://2zsfe53xffwu2o";
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10003", "CompF7") as FGUICompF7;
	...
	public static createInstance():FGUICompF7 {
		return <FGUICompF7>(fgui.UIPackage.createObject("game10003", "CompF7"));
	}
