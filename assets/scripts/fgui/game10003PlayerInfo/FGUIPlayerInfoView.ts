...
export default class FGUIPlayerInfoView extends fgui.GComponent {
	...
	public static packageName:string = "game10003PlayerInfo";
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10003PlayerInfo", "PlayerInfoView") as FGUIPlayerInfoView;
	...
	public static createInstance():FGUIPlayerInfoView {
		return <FGUIPlayerInfoView>(fgui.UIPackage.createObject("game10003PlayerInfo", "PlayerInfoView"));
	}
