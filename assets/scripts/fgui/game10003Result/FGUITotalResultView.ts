...
export default class FGUITotalResultView extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10003Result", "TotalResultView") as FGUITotalResultView;
	...
	public static createInstance():FGUITotalResultView {
		return <FGUITotalResultView>(fgui.UIPackage.createObject("game10003Result", "TotalResultView"));
	}
