...
export default class FGUICompResultInfo extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10003Result", "CompResultInfo") as FGUICompResultInfo;
	...
	public static createInstance():FGUICompResultInfo {
		return <FGUICompResultInfo>(fgui.UIPackage.createObject("game10003Result", "CompResultInfo"));
	}
