...
export default class FGUICompF5 extends fgui.GComponent {
	...
	protected onDestroy():void {
		super.onDestroy();
		FGUICompF5.instance = null;
	}
	public static hideView():void {
		FGUICompF5.instance && FGUICompF5.instance.dispose();
	}
...
fgui.UIObjectFactory.setExtension(FGUICompF5.URL, FGUICompF5);